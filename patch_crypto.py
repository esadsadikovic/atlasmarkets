"""Patch crypto_api: add requestBody to GET endpoints + x-bazaar/requestBody to decision."""
with open('crypto_api/main.py') as f:
    content = f.read()

count = 0

# 1. decision POST: add x-bazaar + requestBody
old = '''        "x-payment-info": {
...
with open('crypto_api/main.py', 'w') as f:
    f.write(content)
