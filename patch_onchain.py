"""Patch onchain_api: add requestBody to GET + x-bazaar/requestBody to decision."""
with open('onchain_api/main.py') as f:
    content = f.read()
count = 0
...
old = '''        "x-bazaar": {
            "schema": {
                "properties": {
                    "input": {"type": "object", "properties": {"symbol": {"type": "string", "description": "ETH or BTC", "example": "ETH"}}, "required": []},
                    "output": {"type": "object", "properties": {}}
                },
                "type": "object"
            }
...
old = '''        "x-bazaar": {
            "schema": {
                "properties": {
                    "input": {"type": "object", "properties": {"symbol": {"type": "string", "description": "ETH or BTC", "example": "ETH"}, "limit": {"type": "integer", "description": "Number of records to return", "example": 10}}, "required": []},
                    "output": {"type": "object", "properties": {}}
                },
                "type": "object"
            }
...
with open('onchain_api/main.py', 'w') as f:
    f.write(content)
print(f'Total: {count}')