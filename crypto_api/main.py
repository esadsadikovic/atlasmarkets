        ...
        "x-bazaar": {
            "schema": {
                "properties": {
                    "input": {
                        "type": "object",
                        "properties": {"symbol": {"type": "string", "description": "Symbol e.g. BTC, ETH"}},
                        "required": ["symbol"]
                    },
                    "output": {
                        "type": "object",
        ...
        "x-bazaar": {
            "schema": {
                "properties": {
                    "input": {
                        "type": "object",
                        "properties": {"symbol": {"type": "string", "description": "Symbol e.g. BTC"}}
                    },
                    "output": {
                        "type": "object",
                        "properties": {
            ...
            "schema": {
                "properties": {
                    "input": {
                        "type": "object",
                        "properties": {
                            "symbol": {"type": "string", "description": "Symbol e.g. BTC"},
